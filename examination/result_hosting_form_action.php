...
<?php
	...
	$physics=$_GET['phy'];
	$chemistry=$_GET['chem'];
	$total=$comp+$english+$maths+$physics+$chemistry;
	$remark1=0;
	$remark2=0;
	$remark3=0;
	$remark4=0;
	...
	<table border=1>
		...
		<td>
			...
			<tr>
				...
				<td>
					<b><font size='5'>BANASTHALI VIDYAPITH</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><br><br>
		...
		<td>
			<table border=1 width=100%>
				...
				<tr><td>101</td><td>Computer</td><td>35</td><td>100</td><td><?php echo "$comp"; ?></td><td><?php echo "$remark1"; ?></td></tr>
