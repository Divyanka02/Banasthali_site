...
<html>
	...
	<body>
		...
		<div class="sidebar">
			...
			<a href="Student-Details.php" class="active"><i class='far fa-address-card'></i><span>Student Details</span></a>
		...
		<div class="content">
			<frameset>
			<iframe src="Student-About-Details.php" alt="back_image" name="portal" frameborder="0" width="1236" height="670px">
			</frameset>
		</div>
