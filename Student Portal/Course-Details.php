...
<html>
	...
	<body>
		...
		<div class="sidebar">
			...
			<a href="Course-Details.php" class="active"><i class='fas fa-book-reader'></i><span>Course Details</span></a>
		...
		<div class="content">
			<frameset>
			<iframe src="Course-About-Details.php" alt="back_image" name="portal" frameborder="0" width="1236" height="670px">
			</frameset>
		</div>
