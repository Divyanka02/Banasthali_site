<?php
    ...
    $query=mysqli_query($con, "SELECT * FROM 'student_detail' WHERE email='session_id()'");
	...
	<body>
		...
		<header>
			...
			<div class="left_area">
				...
				<img src="Student Portal - Copy.png" alt="Student-Portal-Logo" height="50" style="margin-top: -7px" style="box-shadow: 1px 1px 2px black, 0 0 15px blue, 0 0 5px darkblue">
				</a>
			</div>
		...
		<div class="sidebar">
			...
			<a href="Student-Profile-Nav-Bars.php"><i class="fa fa-th"></i><span>Dashboard</span></a>
			<a href="Student-Details.php"><i class='far fa-address-card'></i><span>Student Details</span></a>
			<a href="Course-Details.phpl"><i class='fas fa-book-reader'></i><span>Course Details</span></a>
			...
			<a href="FAQs.php" class="active"><i class='fas fa-question'></i><span>FAQs</span></a>
		</div>
		<!--sidebar end-->
		<div class="content">
			<frameset>
			<iframe src="faqq.html" name="portal" alt="back_image" frameborder="0" width="1236" height="670px">
			</frameset>
		</div>
