...
<html>
	...
	<body>
		...
		<div class="sidebar">
			...
			<a href="Attendance-Details.php" class="active"><i class='fas fa-tasks'></i><span>Attendance</span></a>
		...
		<div class="content">
			<frameset>
			<iframe src="Attendance-About-Details.php" alt="back_image" name="portal" frameborder="0" width="1236" height="670px">
			</frameset>
		</div>
