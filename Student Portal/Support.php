...
<html>
	...
	<body>
		...
		<div class="sidebar">
			...
			<a href="Support.php" class="active"><i class='far fa-handshake'></i><span>Support</span></a>
			<a href="FAQs.php"><i class='fas fa-question'></i><span>FAQs</span></a>
		</div>
		<!--sidebar end-->
		<div class="content">
			<frameset>
			<iframe src="Supportt.html" name="portal" alt="back_image" frameborder="0" width="1236" height="670px">
			</frameset>
		</div>
