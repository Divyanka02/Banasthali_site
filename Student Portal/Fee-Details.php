...
<html>
	...
	<body>
		...
		<div class="sidebar">
			...
			<a href="Fee-Details.php" class="active"><i class='fas fa-money-check'></i><span>Fee Details</span></a>
		...
		<div class="content">
			<frameset>
			<iframe src="Fee-Detail-Slip.php" alt="back_image" name="portal" frameborder="0" width="1236" height="670px">
			</frameset>
		</div>
